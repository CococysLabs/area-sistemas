...
2. Crea una rama: `git checkout -b feature/720-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(720): agregar [descripción]"`
...
**Ruta:** [Área de Sistemas](../) → [720] Modelación y Simulación 2
