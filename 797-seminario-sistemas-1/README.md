...
2. Crea una rama: `git checkout -b feature/797-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(797): agregar [descripción]"`
...
**Ruta:** [Área de Sistemas](../) → [797] Seminario de Sistemas 1
