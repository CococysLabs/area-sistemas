...
2. Crea una rama: `git checkout -b feature/722-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(722): agregar [descripción]"`
...
**Ruta:** [Área de Sistemas](../) → [722] Teoría de Sistemas 1
