...
2. Crea una rama: `git checkout -b feature/798-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(798): agregar [descripción]"`
...
**Ruta:** [Área de Sistemas](../) → [798] Seminario de Sistemas 2
